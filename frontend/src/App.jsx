                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 0", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                          <div>
                            ...
                            <div style={{ fontSize: 11, color: "var(--color-text-tertiary)", marginTop: 2 }}>Update card, view billing history via Polar portal</div>
                          </div>
  ...
  const goToCheckout = async () => {
    ...
    try {
      ...
      if (data.test_mode) {
        ...
        // Live mode: redirect to Polar hosted checkout
  ...
  if (inlineMode) {
    return (
      <div>
        ...
        <div style={{ marginTop: 10, fontSize: 11, color: "var(--color-text-tertiary)" }}>🔒 Secured by Polar · No charge for 7 days</div>
      </div>
    );
  }
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: "32px 36px 36px" }}>
          ...
          <div style={{ textAlign: "center", marginTop: 12, fontSize: 11, color: "var(--color-text-tertiary)" }}>🔒 Secured by Polar · No charge for 7 days</div>
        </div>
      </div>
    </div>
  );
...
function AuthenticatedApp() {
  ...
  useEffect(() => {
    ...
    // On return from Polar checkout, clean the URL but STILL re-fetch
