      ...
      <div className="legal-root">
        <div className="legal-card">
          ...
          <div className="legal-section">
            ...
            <ul className="legal-ul">
              <li>Dodo Payments — payment processing for subscriptions.</li>
              <li>Slack — to receive and process messages you choose to connect, for AI task extraction.</li>
              <li>Hosting and infrastructure providers (Railway, Vercel) that run and serve the Service.</li>
            </ul>
          </div>
