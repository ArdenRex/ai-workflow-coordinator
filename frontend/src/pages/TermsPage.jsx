      ...
      <div className="legal-root">
        <div className="legal-card">
          ...
          <div className="legal-section">
            ...
            <p className="legal-p">
              Subscriptions are billed monthly. Payments are processed securely through Lemon Squeezy. By subscribing, you authorize us to charge your payment method on a recurring basis until you cancel.
            </p>
